                ...
                when (events[i]) {
                    ...
                    Player.EVENT_IS_PLAYING_CHANGED -> {
                        if (player.isPlaying) {
                            ...
                            // Audio focus loss can suppress ExoPlayer without changing
                            // playWhenReady. Keep the exposed state in sync so RNTP
                            // clients update their play/pause controls immediately.
                            playerState = AudioPlayerState.PAUSED
                        }
                    }
                }
