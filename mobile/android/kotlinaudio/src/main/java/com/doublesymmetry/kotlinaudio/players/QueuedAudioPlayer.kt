...
class QueuedAudioPlayer(
    ...
    fun move(fromIndex: Int, toIndex: Int) {
        ...
        // ExoPlayer reports/uses the destination as the item's final index.
        // Keep KotlinAudio's mirror in exactly the same order.  Subtracting
        // one for backward moves shifts the item one slot too far left and
        // makes currentItem point at a different track than the audio engine.
